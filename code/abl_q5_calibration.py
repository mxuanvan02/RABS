#!/usr/bin/env python3
"""Q5 support: empirical calibration between the missed-risk SURROGATE Mhat_t
...
def main():
    ...
    with (OUT / 'rabs_q5_surrogate_calibration.csv').open('w', newline='', encoding='utf-8') as f:
        w = csv.DictWriter(f, fieldnames=list(rows[0].keys())); w.writeheader(); w.writerows(rows)
    print('WROTE', OUT / 'rabs_q5_surrogate_calibration.csv')
