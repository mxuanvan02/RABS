...
SIGMA = 1.2
NETWORKS = {'extreme_burst': (0.12, 0.070, 0.90, 0.08)}
...
def main():
    ...
    with (OUT / 'rabs_era5_extreme_raw.csv').open('w', newline='', encoding='utf-8') as f:
    ...
    for net in NETWORKS:
        for pol in POLICIES:
            ...
            summ.append(rec)
    with (OUT / 'rabs_era5_extreme_summary.csv').open('w', newline='', encoding='utf-8') as f:
